...
{
    public class Trinet_Command_MeshProcessor : BaseMeshProcessor
    {
        public Trinet_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          TrinetConstants.ProviderId;

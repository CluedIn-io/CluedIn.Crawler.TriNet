...
namespace CluedIn.Crawling.Trinet.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<ITrinetClientFactory>().AsFactory())
                .Register(Component.For<TrinetClient>().LifestyleTransient());

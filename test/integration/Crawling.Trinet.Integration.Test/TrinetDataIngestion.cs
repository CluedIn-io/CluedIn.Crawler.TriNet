...
{
    public class DataIngestion : IClassFixture<TrinetTestFixture>
    {
        private readonly TrinetTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(TrinetTestFixture fixture, ITestOutputHelper output)
        {
